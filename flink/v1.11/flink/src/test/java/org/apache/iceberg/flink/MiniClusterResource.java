...
public class MiniClusterResource {
  ...
  private static final ConfigOption<Boolean> CHECK_LEAKED_CLASSLOADER =
      ConfigOptions.key("classloader.check-leaked-classloader")
          ...
          .withDescription(
              "Fails attempts at loading classes if the user classloader of a job is used after it has " +
                  "terminated.\n " +
                  "This is usually caused by the classloader being leaked by lingering threads or " +
                  "misbehaving libraries, which may also result in the classloader being used by other jobs.\n" +
  ...
  public static final Configuration DISABLE_CLASSLOADER_CHECK_CONFIG = new Configuration()
      ...
      .set(CHECK_LEAKED_CLASSLOADER, false);
