...
public class IcebergFlinkCommittable implements Serializable {
  ...
  public IcebergFlinkCommittable(WriteResult committable, String jobID) {
    this.committable = committable;
    this.jobID = jobID;
  }

  public IcebergFlinkCommittable(WriteResult committable, String jobID, long checkpointId, int subtaskId) {
    this.committable = committable;
    this.jobID = jobID;
