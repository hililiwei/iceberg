...
public class IcebergStreamWriterStateSerializer<T> implements SimpleVersionedSerializer<IcebergStreamWriterState<T>> {
  ...
  @Override
  public IcebergStreamWriterState<T> deserialize(int version, byte[] serialized) throws IOException {
    switch (version) {
      case 1:
        Object obj = null;
        try {
        ...
        return (IcebergStreamWriterState<T>) obj;
      default:
