...
public class TestIcebergStreamWriter {
  ...
  private OneInputStreamOperatorTestHarness<RowData, WriteResult> createIcebergStreamWriter(
    ...
    IcebergStreamWriter<RowData> streamWriter = FlinkSink.createStreamWriter(icebergTable,
            PropertyUtil.propertyAsLong(icebergTable.properties(),
                    TableProperties.WRITE_TARGET_FILE_SIZE_BYTES,
                    TableProperties.WRITE_TARGET_FILE_SIZE_BYTES_DEFAULT),
            FileFormat.valueOf(PropertyUtil.propertyAsString(icebergTable.properties(),
