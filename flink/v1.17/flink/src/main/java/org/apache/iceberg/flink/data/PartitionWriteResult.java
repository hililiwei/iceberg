...
public class PartitionWriteResult extends WriteResult {
  private static final long serialVersionUID = 1L;

  private final PartitionKey partitionKey;

  private PartitionWriteResult(
  ...
  public static class PartitionWriteResultBuilder {
    ...
    public PartitionWriteResultBuilder add(PartitionWriteResult result) {
    ...
    public PartitionWriteResultBuilder addAll(Iterable<PartitionWriteResult> results) {
    ...
    public PartitionWriteResult build() {
      return new PartitionWriteResult(dataFiles, deleteFiles, referencedDataFiles, partitionKey);
    }
  }
}
