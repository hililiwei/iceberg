  ...
  public static class WriteBuilder {
    ...
    private static class Context {
      ...
      static Context dataContext(Map<String, String> conf) {
        long stripeSize = PropertyUtil.propertyAsLong(conf,
        ...
        long blockSize = PropertyUtil.propertyAsLong(conf,
        ...
        int vectorizedRowBatchSize = PropertyUtil.propertyAsInt(conf,
      ...
      static Context deleteContext(Map<String, String> conf) {
