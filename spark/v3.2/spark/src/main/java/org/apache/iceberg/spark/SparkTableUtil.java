...
public class SparkTableUtil {
   ...
   */
  public static ImportSparkTableBuilder importSparkTableBuilder(SparkSession spark, TableIdentifier sourceTableIdent,
      Table targetTable, String stagingDir) {
    return new ImportSparkTableBuilder(spark, sourceTableIdent, targetTable, stagingDir);
  }
  ...
  public static class ImportSparkTableBuilder {
    ...
    boolean checkDuplicateFiles = false;
    boolean skipCorruptFiles = false;
    ...
    public ImportSparkTableBuilder partitionFilter(Map<String, String> newPartitionFilter) {
      this.partitionFilter = newPartitionFilter;
      return this;
    }

    public ImportSparkTableBuilder checkDuplicateFiles(boolean newCheckDuplicateFiles) {
  ...
  public static void importSparkPartitions(SparkSession spark, List<SparkPartition> partitions, Table targetTable,
    ...
    importSparkPartitions(spark, partitions, targetTable, spec, stagingDir, false, false);
  }
